...
function CSSClientsideWeaponSettings()
	...
	local WModelCheckBox = vgui.Create("DCheckBoxLabel", Base1)
		WModelCheckBox:SetText( "Draw Equipment on player's back" )
		WModelCheckBox:SetTextColor( Color(0, 0, 0, 255) )
		WModelCheckBox:SizeToContents()
		WModelCheckBox:SetPos(15, 160 + 250 + 30 + 10 + 10 + 40 + 40 + 40)
		WModelCheckBox:SetConVar( "cl_css_viewmodel_cmodel" )
		--]]
...
function CustomShellEffects(ply)
	...
	local muzzlepos = Weapon:GetAttachment(1).Pos
	local muzzleang = Weapon:GetAttachment(1).Ang				
